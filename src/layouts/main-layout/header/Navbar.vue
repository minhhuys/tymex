...
<div class="app-navbar flex-shrink-0">
  ...
  <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
    <!--begin::Menu wrapper-->
    <div class="cursor-pointer symbol symbol-35px w-160px">
  ...
  <div class="app-navbar-item ms-1 ms-md-3">
    ...
    <a href="#"
      ...
      <KTIcon v-if="themeMode === 'light'" icon-name="abstract-37" icon-class="fs-2" />
      <KTIcon v-else icon-name="abstract-37" icon-class="fs-2" />
    </a>
    <!--begin::Menu toggle-->
    <KTThemeModeSwitcher />
  </div>
  ...
  <div class="app-navbar-item d-lg-none ms-2 me-n2">
    <div class="btn btn-flex flex-end btn-icon btn-active-color-primary w-30px h-30px" id="kt_app_header_menu_toggle">
